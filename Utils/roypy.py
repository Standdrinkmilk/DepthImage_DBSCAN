...
class RawData(_object):
    ...
    if _newclass:
        exposureGroupNames = _swig_property(_roypy.RawData_exposureGroupNames_get,
                                            _roypy.RawData_exposureGroupNames_set)
    ...
    if _newclass:
        modulationFrequencies = _swig_property(_roypy.RawData_modulationFrequencies_get,
                                               _roypy.RawData_modulationFrequencies_set)
    ...
    if _newclass:
        illuminationTemperature = _swig_property(_roypy.RawData_illuminationTemperature_get,
                                                 _roypy.RawData_illuminationTemperature_set)
    ...
    if _newclass:
        illuminationEnabled = _swig_property(_roypy.RawData_illuminationEnabled_get,
                                             _roypy.RawData_illuminationEnabled_set)
...
class IntermediateData(_object):
    ...
    if _newclass:
        modulationFrequencies = _swig_property(_roypy.IntermediateData_modulationFrequencies_get,
                                               _roypy.IntermediateData_modulationFrequencies_set)
    ...
    if _newclass:
        exposureTimes = _swig_property(_roypy.IntermediateData_exposureTimes_get,
                                       _roypy.IntermediateData_exposureTimes_set)
    ...
    if _newclass:
        numFrequencies = _swig_property(_roypy.IntermediateData_numFrequencies_get,
                                        _roypy.IntermediateData_numFrequencies_set)
    ...
    if _newclass:
        processingParameters = _swig_property(_roypy.IntermediateData_processingParameters_get,
                                              _roypy.IntermediateData_processingParameters_set)
...
class LensParameters(_object):
    ...
    if _newclass:
        principalPoint = _swig_property(_roypy.LensParameters_principalPoint_get,
                                        _roypy.LensParameters_principalPoint_set)
    ...
    if _newclass:
        distortionTangential = _swig_property(_roypy.LensParameters_distortionTangential_get,
                                              _roypy.LensParameters_distortionTangential_set)
    ...
    if _newclass:
        distortionRadial = _swig_property(_roypy.LensParameters_distortionRadial_get,
                                          _roypy.LensParameters_distortionRadial_set)
